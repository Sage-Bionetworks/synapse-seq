...
setup(name='synapseSeq', version='0.1adev', author='Kristen Dang',
      ...
      packages=['synapseseq',],
      scripts=['scripts/add_eval.py', 'scripts/eval_align_star.py', 'scripts/eval_browserCoverageTrack.py', 'scripts/eval_fusion_qsub.py', 'scripts/eval_listener.py', 'scripts/eval_quant_sailfish.py', 'scripts/eval_raw_counts_htseq.py', 'scripts/eval_snps_samtools.py'],
